...
echo"<div class='view'><center><a href='client_view.php'>View Products</a></center></div>";
...
if(!$row){
    echo "<marquee class='GeneratedMarquee'  direction='left' scrollamount='12' behavior='alternate'>No items in cart</marquee>";
} 
else{
    echo"<div class='d-flex justify-content-space-between flex-wrap'>";
    while($row=mysqli_fetch_assoc($sql_result))
    {
        ...
        $imsrc=$row['imlocation'];
            ...
            <a href='delete_from_cart.php?pid=$pid'>
             <button class='mybtn btn text-dark' p-3><i class='fa fa-trash'></i></button>
            </a>
             </div> 
           </div>
